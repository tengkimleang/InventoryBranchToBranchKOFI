...
namespace InventoryBranchToBranch
{
    public partial class InventoryBranchToBranch : Form
    {
        ...
        List<ItemLine> ListItemLine = new List<ItemLine>();
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridView1.Columns[e.ColumnIndex].Name == "btnDelete")
            {
                ...
                var itemToRemove = ListItemLine.SingleOrDefault(r => 
                                                                ...
                                                                r.Qty == Convert.ToDouble(dataGridView1.Rows[e.RowIndex].Cells["Quantity"].Value) &&
                                                                r.Price == Convert.ToDouble(dataGridView1.Rows[e.RowIndex].Cells["Total"].Value)
                                                                );
